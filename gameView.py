...
class Player(object):
    #Initialize player
    def __init__(self):
        self.image_surf = pygame.image.load("asset/robin.png").convert_alpha()
        self.resized = pygame.transform.scale(self.image_surf, (28, 45))
        self.x = 10
        self.y = 585
...
def win_page():
    ...
    while True:
        ...
        WIN_BACK = Button(image=pygame.image.load("asset/silang.png"), pos=(895, 35))
...
def lose_page():
    ...
    while True:
        ...
        LOSE_BACK = Button(image=pygame.image.load("asset/silang.png"), pos=(895, 35))
...
for row in level:
    for col in row:
        ...
        if col == "Z":
            ...
            finding_shortest.draw('!')
        if col == "1":
            Road("asset/belok_4.png", x, y)
            finding_shortest.draw('1')
        if col == "2":
            Road("asset/belok_2.png", x, y)
            finding_shortest.draw('2')
        if col == "3":
            Road("asset/belok_3.png", x, y)
            finding_shortest.draw('3')
        if col == "4":
            Road("asset/belok_1.png", x, y)
